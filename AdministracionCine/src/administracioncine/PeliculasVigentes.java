 ...
 * @author famii
 */
public class PeliculasVigentes {
    String Nombre;
    String Edades;
    String Descripcion;
    String Formato;
    ...
    public PeliculasVigentes() {
    }

    public PeliculasVigentes(String Nombre, String Edades, String Descripcion, String Formato, String Duracion, String Genero, String Idioma, String Trailer, Date Fecha, String Horario, double PrecioNiño, double PrecioAdulto, double Precio3raEdad) {
        this.Nombre = Nombre;
        this.Edades = Edades;
